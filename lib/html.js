...
<body>
    ...
    <div style="position: fixed; bottom: 10px;">
        ...
        Template By <a target="_blank" href="https://github.com/gkajs/gka-tpl-studiojs">gka-tpl-studiojs</a> ${pkg.version}
    </div>
    ...
    <script>
        ...
        img.onload = () => {
            ...
            var material = new Frame(canvas, frameData, "default", ${Math.round(0.04 * 1000 / 16)});
